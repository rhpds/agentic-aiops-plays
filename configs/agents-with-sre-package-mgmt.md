...
- **sre_ansible**: Playbook/role/collection errors, credential issues, execution environment problems, variable resolution, job template misconfiguration (NOT package manager errors or missing packages — route those to sre_package_management)
